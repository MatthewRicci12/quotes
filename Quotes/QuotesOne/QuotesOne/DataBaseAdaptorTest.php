...
$theDBA->addQuote('How little is required for pleasure! The sound of a bagpipe - without music, life would be an error.', 'Friedrich Nietzsche');
$theDBA->addQuote('Great fish do not swim in shallow waters.', 'Matshona Dhliwayo');
$theDBA->addQuote('A brave man acknowledges the strength of others.', 'Veronica Roth');
?>